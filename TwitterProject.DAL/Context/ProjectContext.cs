...
using TwitterProject.Map.Option;
using TwitterProject.Model.Option;
using TwitterProject.Utility;

namespace TwitterProject.DAL.Context
{
    public class ProjectContext : DbContext
    {
        public ProjectContext()
        {
            ...
            Database.Connection.ConnectionString = "Server=.;Database=TwitterProject;uid=berivan;pwd=1234;";
        }
